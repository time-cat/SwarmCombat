...
bool fwp_planner__msg__fused_enemy__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fwp_planner.msg._fused_enemy.FusedEnemy", full_classname_dest, 39) == 0);
  }
  fwp_planner__msg__FusedEnemy * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of FusedEnemy */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fwp_planner.msg._fused_enemy");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FusedEnemy");
