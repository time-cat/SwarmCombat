...
class Metaclass_TeamBroadcast(type):
    """Metaclass of message 'TeamBroadcast'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'fwp_planner.msg.TeamBroadcast')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__team_broadcast
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__team_broadcast
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__team_broadcast
            cls._TYPE_SUPPORT = module.type_support_msg__msg__team_broadcast
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__team_broadcast
...
class TeamBroadcast(metaclass=Metaclass_TeamBroadcast):
    """Message class 'TeamBroadcast'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.broadcast_range = kwargs.get('broadcast_range', float())
        from fwp_planner.msg import DynamicState
    ...
    def __eq__(self, other):
        ...
        if self.sender_id != other.sender_id:
            return False
        if self.broadcast_range != other.broadcast_range:
            return False
    ...
    def broadcast_range(self, value):
        if __debug__:
            assert \
                ...
                "The 'broadcast_range' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'broadcast_range' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
