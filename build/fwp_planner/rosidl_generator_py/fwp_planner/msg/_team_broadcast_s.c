...
bool fwp_planner__msg__team_broadcast__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fwp_planner.msg._team_broadcast.TeamBroadcast", full_classname_dest, 45) == 0);
  }
  fwp_planner__msg__TeamBroadcast * ros_message = _ros_message;
  {  // header
  ...
  {  // broadcast_range
    PyObject * field = PyObject_GetAttrString(_pymsg, "broadcast_range");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->broadcast_range = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // dynamic_state
...
{
  /* NOTE(esteve): Call constructor of TeamBroadcast */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fwp_planner.msg._team_broadcast");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TeamBroadcast");
  ...
  {  // broadcast_range
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->broadcast_range);
    {
      int rc = PyObject_SetAttrString(_pymessage, "broadcast_range", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
