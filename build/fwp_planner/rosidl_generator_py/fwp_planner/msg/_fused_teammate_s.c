...
bool fwp_planner__msg__fused_teammate__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fwp_planner.msg._fused_teammate.FusedTeammate", full_classname_dest, 45) == 0);
  }
  fwp_planner__msg__FusedTeammate * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of FusedTeammate */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fwp_planner.msg._fused_teammate");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FusedTeammate");
