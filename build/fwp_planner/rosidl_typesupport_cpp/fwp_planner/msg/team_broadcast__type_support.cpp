...
static const _TeamBroadcast_type_support_symbol_names_t _TeamBroadcast_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fwp_planner, msg, TeamBroadcast)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fwp_planner, msg, TeamBroadcast)),
  }
};
...
{
  return &::fwp_planner::msg::rosidl_typesupport_cpp::TeamBroadcast_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fwp_planner, msg, TeamBroadcast)() {
  return get_message_type_support_handle<fwp_planner::msg::TeamBroadcast>();
}
