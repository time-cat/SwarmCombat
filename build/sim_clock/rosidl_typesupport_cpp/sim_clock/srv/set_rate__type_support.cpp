...
static const _SetRate_Request_type_support_symbol_names_t _SetRate_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sim_clock, srv, SetRate_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sim_clock, srv, SetRate_Request)),
  }
};
...
{
  return &::sim_clock::srv::rosidl_typesupport_cpp::SetRate_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sim_clock, srv, SetRate_Request)() {
  return get_message_type_support_handle<sim_clock::srv::SetRate_Request>();
}
...
static const _SetRate_Response_type_support_symbol_names_t _SetRate_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sim_clock, srv, SetRate_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sim_clock, srv, SetRate_Response)),
  }
};
...
{
  return &::sim_clock::srv::rosidl_typesupport_cpp::SetRate_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sim_clock, srv, SetRate_Response)() {
  return get_message_type_support_handle<sim_clock::srv::SetRate_Response>();
}
...
static const _SetRate_type_support_symbol_names_t _SetRate_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sim_clock, srv, SetRate)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sim_clock, srv, SetRate)),
  }
};
...
{
  return &::sim_clock::srv::rosidl_typesupport_cpp::SetRate_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, sim_clock, srv, SetRate)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<sim_clock::srv::SetRate>();
}
