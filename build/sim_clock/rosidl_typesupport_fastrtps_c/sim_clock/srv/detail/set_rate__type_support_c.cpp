...
#include "sim_clock/srv/detail/set_rate__rosidl_typesupport_fastrtps_c.h"
...
#include "sim_clock/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _SetRate_Request__ros_msg_type = sim_clock__srv__SetRate_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sim_clock
size_t get_serialized_size_sim_clock__srv__SetRate_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetRate_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sim_clock__srv__SetRate_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sim_clock
size_t max_serialized_size_sim_clock__srv__SetRate_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sim_clock__srv__SetRate_Request;
    is_plain =
      (
...
static size_t _SetRate_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sim_clock__srv__SetRate_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sim_clock, srv, SetRate_Request)() {
...
using _SetRate_Response__ros_msg_type = sim_clock__srv__SetRate_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sim_clock
size_t get_serialized_size_sim_clock__srv__SetRate_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetRate_Response__ros_msg_type * ros_message = static_cast<const _SetRate_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_sim_clock__srv__SetRate_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sim_clock
size_t max_serialized_size_sim_clock__srv__SetRate_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = sim_clock__srv__SetRate_Response;
    is_plain =
      (
...
static size_t _SetRate_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sim_clock__srv__SetRate_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sim_clock, srv, SetRate_Response)() {
...
// already included above
// #include "sim_clock/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "sim_clock/srv/set_rate.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sim_clock, srv, SetRate)() {
