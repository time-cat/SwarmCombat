...
#include "sim_clock/srv/detail/set_rate__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sim_clock::srv::SetRate_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sim_clock::srv::SetRate_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sim_clock::srv::SetRate_Request *>(
    untyped_ros_message);
...
static size_t _SetRate_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetRate_Request(full_bounded, is_plain, 0);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_sim_clock
const rosidl_message_type_support_t *
get_message_type_support_handle<sim_clock::srv::SetRate_Request>()
{
  return &sim_clock::srv::typesupport_fastrtps_cpp::_SetRate_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = sim_clock::srv::SetRate_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sim_clock::srv::SetRate_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<sim_clock::srv::SetRate_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _SetRate_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetRate_Response(full_bounded, is_plain, 0);
...
{
  return &sim_clock::srv::typesupport_fastrtps_cpp::_SetRate_Response__handle;
}
...
{
  return &sim_clock::srv::typesupport_fastrtps_cpp::_SetRate__handle;
}
