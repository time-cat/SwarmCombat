...
class Metaclass_SetRate_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('sim_clock')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_SetRate(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from sim_clock.srv import _set_rate
...
class SetRate(metaclass=Metaclass_SetRate):
    from sim_clock.srv._set_rate import SetRate_Request as Request
    from sim_clock.srv._set_rate import SetRate_Response as Response
