...
#ifndef SIM_CLOCK__SRV__DETAIL__SET_RATE__FUNCTIONS_H_
#define SIM_CLOCK__SRV__DETAIL__SET_RATE__FUNCTIONS_H_
...
#include "sim_clock/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_sim_clock
bool
 ...
 * calls
 * sim_clock__srv__SetRate_Request__init().
...
/**
 * It calls
 * sim_clock__srv__SetRate_Request__fini()
 ...
 * sim_clock__srv__SetRate_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * sim_clock__srv__SetRate_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * sim_clock__srv__SetRate_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sim_clock
...
/**
 * It calls
 * sim_clock__srv__SetRate_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_sim_clock
...
/**
 * It allocates the memory for the array and calls
 * sim_clock__srv__SetRate_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sim_clock
...
/**
 * It calls
 * sim_clock__srv__SetRate_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SIM_CLOCK__SRV__DETAIL__SET_RATE__FUNCTIONS_H_
