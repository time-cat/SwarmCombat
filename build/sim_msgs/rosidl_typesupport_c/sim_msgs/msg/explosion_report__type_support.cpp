...
static const _ExplosionReport_type_support_symbol_names_t _ExplosionReport_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sim_msgs, msg, ExplosionReport)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sim_msgs, msg, ExplosionReport)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sim_msgs, msg, ExplosionReport)() {
  return &::sim_msgs::msg::rosidl_typesupport_c::ExplosionReport_message_type_support_handle;
}
